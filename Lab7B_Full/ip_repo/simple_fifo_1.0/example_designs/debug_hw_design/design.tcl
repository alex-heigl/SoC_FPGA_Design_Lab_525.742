...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins simple_fifo_0/S00_AXIS_LITE]
	connect_bd_net [get_bd_pins simple_fifo_0/s00_axis_lite_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins simple_fifo_0/s00_axis_lite_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of simple_fifo_0 streaming interfaces..
	connect_bd_net [get_bd_pins simple_fifo_0/s00_axis_stream_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins simple_fifo_0/s00_axis_stream_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_simple_fifo_0_S00_AXIS_LITE_* ]]
	puts $fp "set s00_axis_lite_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores ge.com:user:simple_fifo:1.0]]]]
